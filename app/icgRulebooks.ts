...
export const rulebooks: Record<"MLBB" | "VALORANT", Rulebook> = {
  MLBB: {
    ...
    snapshot: [
      ["Date", "8 Oct 2026"], ["Time", "17:15-20:30"], ["Preferred venue", "Valour House Level 2 Seminar Room"],
  ...
  VALORANT: {
    title: "VALORANT",
    snapshot: [
      ["Competition days", "9-11 Oct 2026"], ["Preferred venue", "NUS E-Sports Room at Yusof Ishak House (YIH)"], ["Game mode", "Standard 5v5 Competitive Mode"], ["Match format", "Best-of-One (BO1)"],
      ["Format", "Single round robin"], ["Points", "Win = 1 point; loss = 0 points"], ["Match distribution", "10 matches across 3 days (4 + 3 + 3)"], ["Equipment provided", "Desktop PC and monitor with VALORANT installed, keyboard, mouse, and headset"], ["Player peripherals", "Players are strongly encouraged to bring and use their own compatible peripherals"],
    ],
    fixtures: {
      headers: ["Day", "Match", "Fixture"],
      rows: [["Day 1", "Match 1", "Cluster 2 vs Cluster 3"], ["Day 1", "Match 2", "Cluster 3 vs Cluster 1"], ["Day 1", "Match 3", "Cluster 1 vs Cluster 4"], ["Day 1", "Match 4", "Cluster 4 vs Cluster 5"], ["Day 2", "Match 5", "Cluster 1 vs Cluster 5"], ["Day 2", "Match 6", "Cluster 5 vs Cluster 3"], ["Day 2", "Match 7", "Cluster 2 vs Cluster 4"], ["Day 3", "Match 8", "Cluster 1 vs Cluster 2"], ["Day 3", "Match 9", "Cluster 2 vs Cluster 5"], ["Day 3", "Match 10", "Cluster 3 vs Cluster 4"]],
    },
    sections: [
      { title: "Sub-Schedule", items: ["9 Oct 2026: 13:45-14:00 Check-in; 14:00-18:00 Matches 1-4", "10 Oct 2026: 18:45-19:00 Check-in; 19:00-22:00 Matches 5-7", "11 Oct 2026: 18:45-19:00 Check-in; 19:00-22:00 Matches 8-10 and final results confirmation"] },
