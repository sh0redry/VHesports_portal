...
function Header({ route, go }: { route: Page; go: (to: Page) => void }) {
  ...
  return <header className="site-header">
    <a className="wordmark" href="/" onClick={navigate("/")}><span className="wordmark-mark">VH</span><span>VALOUR HOUSE<br /><b>E-SPORTS</b></span></a>
...
function Home({ go }: { go: (to: Page) => void }) {
  ...
  return <>
    <section className="hero"><div className="hero-glow" /><div className="hero-copy"><p className="eyebrow">VALOUR HOUSE / NUS</p><h1>Play<br /><em>Together.</em></h1><p className="hero-text">A welcoming esports community for every game, platform and skill level.</p><button className="button primary" onClick={() => go("/join")}>Join Our Community -&gt;</button></div><p className="hero-logo">VALOUR HOUSE<br />E-SPORTS</p></section>
